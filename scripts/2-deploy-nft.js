...
async function run(runtimeEnv, deployer) {
    ...
    await Promise.all(assets.map(async (asset) => {
        ...
        const metadata = {
            ...
            image: `ipfs://${result.IpfsHash}/Users/pc/Desktop/arc3-nft-Fatinefadli-main/assets/nft/${asset.file}`,
            image_integrity: `sha256-${integrity.base64}`,
            image_mimetype: asset.image_mimetype,
            properties: {
                file_url: `https://gateway.pinata.cloud/ipfs/${result.IpfsHash}/Users/pc/Desktop/arc3-nft-Fatinefadli-main/assets/nft/${asset.file}`,
